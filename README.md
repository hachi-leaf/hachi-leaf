...
- 🔭 Working on: `ROS2` · `BSP` · `机械臂` · `AI Agent` · `DL` · `LLM` · `3D打印` · `机械结构`
...
| ⭐ | Project | Description |
|----|---------|-------------|
| 12 | **[Horizon_yolov5_tools](https://github.com/hachi-leaf/Horizon_yolov5_tools)** | 基于 RDK 系列开发板的 YOLOv5 工具库 · 模型转换 / 量化 / 部署 |
